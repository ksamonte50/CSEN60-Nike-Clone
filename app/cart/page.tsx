            ...
            <aside className =" w-full max-w-80" >
                ...
                <div className=" flex-row-container flex flex-row justify-between items-start pb-2" >
                    ...
                    <ul className ="flex flex-col items-end">
                        ...
                        <li className ="font-light pb-2">$120.00</li>
                ...
                <button className="bg-gray-100 py-2 px-6 rounded-full w-full h-16 flex items-center justify-center space-x-2 text-base italic font-bold">
                    <span>
