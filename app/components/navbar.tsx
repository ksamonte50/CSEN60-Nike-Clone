...
export default function Navbar() {
  const { cartCount } = useCart(); // Assuming `cartItems` is an array of items in the cart
  // const cartCount = cartItems?.length || 0; // Calculate the number of items
